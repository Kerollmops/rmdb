...
extern "C" {
    ...
    fn fputs(_: *const std::ffi::c_char, _: *mut FILE) -> std::ffi::c_int;
    ...
    fn mdb_reader_check(env: *mut MDB_env, dead: *mut std::ffi::c_int) -> std::ffi::c_int;
}
...
unsafe fn main_0(
    ...
    if alldbs != 0 || !subname.is_null() {
        mdb_env_set_maxdbs(env, 4 as std::ffi::c_int as MDB_dbi);
    }
    rc = mdb_env_open(
        env,
        envname,
    ...
    if rc != 0 {
        ...
        if envinfo != 0 {
            ...
            printf(
                ...
                (mei.me_last_pgno).wrapping_add(1 as std::ffi::c_int as mdb_size_t),
            );
            printf(
        ...
        if rdrinfo != 0 {
            ...
            rc = mdb_reader_list(
                ...
                ::core::mem::transmute::<
                    Option<
                        unsafe extern "C" fn(*const std::ffi::c_char, *mut FILE) -> std::ffi::c_int,
                    >,
                    Option<MDB_msg_func>,
                >(Some(
                    fputs
                ...
                if rc != 0 {
                    ...
                    if freinfo != 0 {
                        ...
                        let mut data: MDB_val =
                            MDB_val { mv_size: 0, mv_data: 0 as *mut std::ffi::c_void };
                        let mut pages: mdb_size_t = 0 as std::ffi::c_int as mdb_size_t;
                        let mut iptr: *mut mdb_size_t = 0 as *mut mdb_size_t;
                        printf(b"Freelist Status\n\0" as *const u8 as *const std::ffi::c_char);
                        dbi = 0 as std::ffi::c_int as MDB_dbi;
                            ...
                            if rc != 0 {
                                ...
                                loop {
                                    ...
                                    if freinfo > 1 as std::ffi::c_int {
                                        ...
                                        let mut j: ssize_t = 0;
                                        let mut span: ssize_t = 0 as std::ffi::c_int as ssize_t;
                                        let fresh0 = iptr;
                                        iptr = iptr.offset(1);
                                        j = *fresh0 as ssize_t;
                                        i_0 = j;
                                        prev = 1 as std::ffi::c_int as mdb_size_t;
                                        loop {
                                            i_0 -= 1;
                                            if !(i_0 >= 0 as std::ffi::c_int as ssize_t) {
                                                break;
                                            }
                                        ...
                                        if freinfo > 2 as std::ffi::c_int {
                                            j -= 1;
                                            j;
                                            while j >= 0 as std::ffi::c_int as ssize_t {
                                                pg = *iptr.offset(j as isize);
                                                span = 1 as std::ffi::c_int as ssize_t;
                                                loop {
                                                    j -= 1;
                                                ...
                                                printf(
                                                    if span > 1 as std::ffi::c_int as ssize_t {
                                                        b"     %9zu[%zd]\n\0" as *const u8
                                                            as *const std::ffi::c_char
                                                    } else {
                                                        b"     %9zu\n\0" as *const u8
                                    ...
                                    if alldbs != 0 {
                                        ...
                                        if rc != 0 {
                                            ...
                                            loop {
                                                ...
                                                str =
                                                    malloc((key_0.mv_size).wrapping_add(
